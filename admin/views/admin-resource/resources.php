...
<div class="contenter">
    <div class="alert alert-info mt" role="alert">
        ...
        <p>set administrator resource: <i class="fa fa-superpowers fa-fw"></i><?= AdminResource::$typeSelector[$type] ?> data <?= $resource->id ?>'s permission.</p>
    ...
    <form id="info-detail" action="/admin-resource/<?= $commit ?>" method="post">
