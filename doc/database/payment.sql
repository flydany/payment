...
INSERT INTO `admin_resource` VALUES (18, 2, '3', 4, 1532401732, 1532401732);
...
INSERT INTO `merchant` VALUES (4, 'baofoo super permission', 3, '', 0, '', '', '', '', '', '', '0', '0', '0', '0', '', 0, 0, 1532401732, 1532419352);
COMMIT;
...
CREATE TABLE `merchant_bank_maintain` (
  ...
  `finish_time` varchar(512) NOT NULL DEFAULT '' COMMENT '结束时间',
