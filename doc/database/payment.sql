...
CREATE TABLE `admin_permission` (
  ...
  `navigator_path` varchar(128) NOT NULL COMMENT '菜单路径，格式->CONTROLLER~METHOD',
  `created_at` int(11) unsigned NOT NULL COMMENT '添加时间',
  `updated_at` int(11) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `index_identify_navigator_path_admin_permission` (`identity`,`navigator_path`)
...
-- Records of card
-- ----------------------------
INSERT INTO `card` VALUES ('1', '7', '6217001210042615144', '孙标', '341222198911241433', '13761665439', '上海市', '上海市', '普陀区', '中潭路支行', null, '0', '1530164509', '1530164509');
